...
public class ProposalController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "PROPOSAL401", description = "PROPOSAL_INVALID_COMPANY, 제안서의 주체는 기업이어야 합니다."),
            @ApiResponse(responseCode = "PROPOSAL402", description = "PROPOSAL_USER_NOT_FOUND, 제안서의 주체를 찾을 수 었습니다."),
    })
